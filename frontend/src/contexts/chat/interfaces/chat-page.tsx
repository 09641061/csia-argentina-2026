        ...
        {conversation && (
          <>
            ...
            <div className="space-y-9" aria-live="polite">
              {orderedMessages(conversation.messages).map((message) => (
...
function orderedMessages(messages: readonly ChatMessage[]): readonly ChatMessage[] {
  // Message ids reflect insertion order and remain reliable when older
  // records have timestamps generated by the model instead of the UI.
