...
import { SubmitSecureQuery } from '@/modules/secure-query/application/submit-secure-query'
...
import type { SecureQueryRepository } from '@/modules/secure-query/domain/secure-query-repository'
